...
export default function Home() {
  ...
  return (
    <div className="relative bg-[#1a1a1a]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#1a1a1a]/95 backdrop-blur-sm border-b border-[#c9a961]/20">
        <div className="container mx-auto px-8 py-4 flex items-center justify-between">
          <div className="flex items-center">
            <img
              src="/fortisfundamenta_logo_4.png"
              alt="Fortis Fundamenta Logo"
          ...
          <div className="flex gap-8 text-sm tracking-wide">
            <a
              href="/Team"
              className="text-white hover:text-[#c9a961] transition-colors duration-300"
            >
              THE TEAM
            </a>
            <a
      ...
      >
        ...
        <div className="text-center text-white z-10 px-8 max-w-5xl">
          ...
          <p className="text-lg md:text-xl text-[#c9a961] font-light tracking-wide">
            Innovation that shapes tomorrows world.
          </p>
        </div>
      </section>
      ...
      <section
        id="slide2"
        className="h-screen flex items-center justify-center bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] relative overflow-hidden"
      >
        ...
        <div className="text-center text-white z-10 px-8 max-w-5xl">
          ...
          <p className="text-lg md:text-xl text-gray-300 font-light max-w-3xl mx-auto leading-relaxed">
            From engineering and technology to capital and development — a
            legacy of execution.
          </p>
        </div>
      </section>
      ...
      <section
        id="slide3"
        className="h-screen flex items-center justify-center relative overflow-hidden bg-[#1a1a1a]"
      >
      ...
      <section
        id="slide4"
        className="h-screen flex items-center justify-center bg-[#1a1a1a] relative overflow-hidden"
      >
      ...
      <section
        id="slide5"
        className="h-screen flex items-center justify-center bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] relative"
      >
        ...
        <div className="text-center text-white z-10 px-8 max-w-5xl">
          ...
          <p className="text-lg md:text-xl text-gray-300 font-light mb-12 max-w-3xl mx-auto leading-relaxed">
            Partner with Fortis Fundamenta and invest in the foundations of the
            future.
          </p>
