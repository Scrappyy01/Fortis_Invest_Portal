      ...
      <div className="relative z-10 bg-[#1a1a1a]/95">
        ...
        <main className="container mx-auto px-8 pt-32 pb-16 space-y-16">
          ...
          <section className="max-w-6xl mx-auto text-center pt-8 pb-4">
            <h1
              className="text-5xl md:text-7xl lg:text-6xl font-bold tracking-tight text-[#c9a961] mb-2 transition-all duration-1000 delay-500 opacity-100 translate-y-0"
              style={{
            ...
            <h1
              className="text-4xl md:text-6xl lg:text-5xl font-bold tracking-tight text-[#c9a961] mb-4 transition-all duration-1000 delay-500 opacity-100 translate-y-0"
              style={{
                fontFamily: "'Unica One', sans-serif",
                textShadow:
...
function ProjectCard({ image, title, description, value }) {
  return (
    <div className="relative rounded-2xl shadow-lg h-[440px] overflow-hidden group">
      <img
        src={image}
